...
public class RenamingQuantifierVarVisitor extends DuplicatingVisitor<Void> {

    private static final RenamingQuantifierVarVisitor INSTANCE = new RenamingQuantifierVarVisitor();

    public static RenamingQuantifierVarVisitor getInstance(){
        return INSTANCE;
    }
