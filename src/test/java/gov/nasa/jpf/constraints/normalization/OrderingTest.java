...
public class OrderingTest {
    ...
    Expression e6 = NumericBooleanExpression.create(c1, NumericComparator.LE, a);
    ...
    public void orderingTest6(){
        ...
        NumericCompound aOrdered = NumericCompound.create(UnaryMinus.create(x), NumericOperator.PLUS, c1);
        Expression expected = NumericBooleanExpression.create(aOrdered, NumericComparator.GT, c1);
